...
public class MatchLiveAdapter1 extends RecyclerView.Adapter<MatchLiveAdapter1.MyViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull MatchLiveAdapter1.MyViewHolder holder, int i) {
    ...
    @NonNull
    @Override
    public MatchLiveAdapter1.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new MatchLiveAdapter1.MyViewHolder(LayoutInflater.from(context).inflate(R.layout.card_live_type1,viewGroup,false));
    }
