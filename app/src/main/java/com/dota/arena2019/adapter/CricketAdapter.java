...
public class CricketAdapter extends RecyclerView.Adapter<CricketAdapter.MyViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull CricketAdapter.MyViewHolder holder, int i) {
    ...
    @NonNull
    @Override
    public CricketAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new CricketAdapter.MyViewHolder(LayoutInflater.from(context).inflate(R.layout.card_cricket,viewGroup,false));
    }
