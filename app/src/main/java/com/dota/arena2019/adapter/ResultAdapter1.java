...
public class ResultAdapter1 extends RecyclerView.Adapter<ResultAdapter1.MyViewHolder>{
    ...
    @Override
    public void onBindViewHolder(@NonNull ResultAdapter1.MyViewHolder holder, int i) {
    ...
    @NonNull
    @Override
    public ResultAdapter1.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new ResultAdapter1.MyViewHolder(LayoutInflater.from(context).inflate(R.layout.card_result_type1,viewGroup,false));
    }
